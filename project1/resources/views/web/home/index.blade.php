      ...
      <div class="shop-top-bar mt-30">
          ...
          <div class="product-view-mode">
            ...
            <ul class="nav shop-item-filter-list" role="tablist">
              <li role="presentation"><a aria-selected="true" class="active show" 
                aria-controls="grid-view" href="#" data-toggle="tab" id="all">
                <i class="fa fa-th">{{ __('lang.all')}}</i></a></li>
              <li><a aria-selected="true" class="show" 
                aria-controls="grid-view" href="#" data-toggle="tab" id="popular">
                <i class="fa fa-fire">{{ __('lang.popular')}}</i></a></li>
              <li><a aria-selected="true" class="show" 
                data-toggle="tab" aria-controls="grid-view" href="#" id="history">
                <i class="fa fa-history">{{ __('lang.history')}}</i></a></li>
            </ul>
        ...
        <div class="product-select-box">
          <div class="product-short">
            <input type="hidden" id="category_sort_by" value="0">
